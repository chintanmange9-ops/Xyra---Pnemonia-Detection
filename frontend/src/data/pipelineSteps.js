const pipelineSteps = [
  ...
  },
  {
    id: 'preprocessing',
    title: 'Preprocessing',
    description: 'The raw X-ray undergoes enhancement and normalization to ensure consistent quality across different scanner types.',
    details: [
      'CLAHE (Contrast Limited Adaptive Histogram Equalization) application',
  ...
  },
  {
    ...
    description: 'The preprocessed image undergoes CLAHE contrast enhancement and is normalized for the classification model.',
    details: [
      'CLAHE (Contrast Limited Adaptive Histogram Equalization)',
      'Pixel intensity normalization to [0, 1] range',
      'Quality validation before classification'
    ],
  ...
  },
  {
    ...
    details: [
      'Grad-CAM for spatial heatmaps of critical regions',
